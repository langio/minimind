...
# 黑盒蒸馏
python train_full_sft.py --dim=${dim} --n_layers=${n_layers} --epochs=1 --data_path=./dataset/sft_1024.jsonl --use_moe=true --use_wandb
python train_full_sft.py --dim=${dim} --n_layers=${n_layers} --epochs=1 --data_path=./dataset/sft_2048.jsonl --use_moe=true --use_wandb
